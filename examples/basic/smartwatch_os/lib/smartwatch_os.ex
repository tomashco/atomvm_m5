defmodule Smartwatch do
  ...
  def start do
    ...
    if :m5_speaker.is_enabled() do
      ...
      wait_until_speaker_is_done()
      # Play raw audio
      :m5_speaker.play_raw_u8(WavData.wav_8bit_44100_binary(), 44100, false)
    end
  ...
  defp manage_buttons(state, screen) do
    ...
    if :m5_btn_a.was_clicked() do
      change_display(state, screen)
    end
  end
  ...
  defp get_new_sec(:second), do: System.monotonic_time(:second)
